...
return new class extends Migration
{
    public function up()
    {
        Schema::create('personals', function (Blueprint $table) {
            ...
            // Información laboral
            $table->date('fecha_ingreso_iess');
            $table->string('estado_contractual');
            ...
            $table->decimal('puntaje_licencia', 5, 2)->default(0);
            ...
            $table->time('hora_ingreso_laboral');
            $table->time('hora_salida_laboral');
            $table->string('cargo_logex');
